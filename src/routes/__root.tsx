...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Living Paris — Have a conversation with Paris" },
      {
        name: "description",
        content:
          "An AI city-companion for Paris. Describe an experience and the map reshapes with recommendations and a walking route.",
      },
      { property: "og:title", content: "Living Paris — Have a conversation with Paris" },
      {
        property: "og:description",
        content: "Describe the Paris you're in the mood for. Watch the city answer.",
      },
